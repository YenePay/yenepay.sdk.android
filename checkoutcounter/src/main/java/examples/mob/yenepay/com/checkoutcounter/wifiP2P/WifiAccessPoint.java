    ...
    public void onGroupInfoAvailable(WifiP2pGroup group) {
        try {
            ...
            if(mNetworkName.equals(group.getNetworkName()) && mPassphrase.equals(group.getPassphrase())){
                ...
                Intent intent = new Intent(WifiServiceSearcher.DSS_WIFISS_PEERAPINFO);
                intent.putExtra(WifiServiceSearcher.DSS_WIFISS_INFOTEXT, mNetworkName + ":" + mPassphrase + ":" + mInetAddress);
    ...
    public void onConnectionInfoAvailable(WifiP2pInfo info) {
        try {
            if (info.isGroupOwner) {
                if(broadcaster != null && info.groupOwnerAddress != null) {
