...
public class WifiServiceSearcher  implements WifiP2pManager.ChannelListener{
    ...
    static final public String DSS_WIFISS_VALUES = "examples.mob.yenepay.com.checkoutcounter.DSS_WIFISS_VALUES";
    static final public String DSS_WIFISS_MESSAGE = "examples.mob.yenepay.com.checkoutcounter.DSS_WIFISS_MESSAGE";

    static final public String DSS_WIFISS_PEERCOUNT = "examples.mob.yenepay.com.checkoutcounter.DSS_WIFISS_PEERCOUNT";
    static final public String DSS_WIFISS_COUNT = "examples.mob.yenepay.com.checkoutcounter.DSS_WIFISS_COUNT";

    static final public String DSS_WIFISS_PEERAPINFO = "examples.mob.yenepay.com.checkoutcounter.DSS_WIFISS_PEERAPINFO";
    static final public String DSS_WIFISS_INFOTEXT = "examples.mob.yenepay.com.checkoutcounter.DSS_WIFISS_INFOTEXT";
        ...
        if (p2p == null) {
            ...
            serviceListener = new WifiP2pManager.DnsSdServiceResponseListener() {
                ...
                public void onDnsSdServiceAvailable(String instanceName, String serviceType, WifiP2pDevice device) {
                     ...
                     if (serviceType.startsWith(WifiAccessPoint.SERVICE_TYPE)) {
                        ...
                        debug_print("Not our Service, :" + WifiAccessPoint.SERVICE_TYPE + "!=" + serviceType + ":");
                    }
    ...
    private void startServiceDiscovery() {
        ...
        WifiP2pDnsSdServiceRequest request = WifiP2pDnsSdServiceRequest.newInstance(WifiAccessPoint.SERVICE_TYPE);
